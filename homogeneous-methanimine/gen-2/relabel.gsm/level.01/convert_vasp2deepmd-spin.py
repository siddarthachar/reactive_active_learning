...
for i, d in enumerate(data_list):
    ...
    for j, im in enumerate(image_list):
        ...
        mag_int_check = ( float(mag_read)) == 0 # checking if total magnetic moment is within a given threshold or not.
        print(mag_int_check)
    ...
    for i, o in enumerate(outcars):
        if i == 0:
            ...
            #change type_file pbs13
#             indexes = np.unique(a, return_index=True)[1]
            type_map = [x for x in elem_dict.keys()]
